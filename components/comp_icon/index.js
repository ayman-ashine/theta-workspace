...
export default function Comp_Icon({ data }) {
    ...
    const ICONS = {
        ...
        'menu-1': (_styles) => {
            ...
            return (
                <svg className={_styles.join(' ')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="50px" height="50px">
        ...
        'menu-2': (_styles) => {
            ...
            return (
                <svg className={_styles.join(' ')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="50" height="50">
        ...
        'grab': (_styles) => {
            ...
            return (
                <svg className={_styles.join(' ')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" width="50px" height="50px" >
        ...
        'start': (_styles) => {
            ...
            return (
                <svg className={_styles.join(' ')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="50px" height="50px" >
        ...
        'reset': (_styles) => {
            ...
            return (
                <svg className={_styles.join(' ')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="50px" height="50px" >
        ...
        'note': (_styles) => {
            ...
            return (
                <svg className={_styles.join(' ')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="50px" height="50px" >
        ...
        <div className='hover-effect-square'>
            {
                ...
                ICONS[data.icon_type](data.icon_styles)
                :
                null
            }
        </div>
