            ...
            <div>
                ...
                <div className={styles.control}>
                    ...
                    <div className={[styles.btn, 'circle'].join(' ')} onClick={start_pause}>
                        <img className={data.start ? 'hide' : ''} src="https://img.icons8.com/material-outlined/40/circled-play.png" />
                        <img className={data.start ? '' : 'hide'} src="https://img.icons8.com/material-outlined/40/circled-pause.png" />
                    </div>

                    <div className={[styles.btn, 'circle'].join(' ')} onClick={reset}>
                        <img src="https://img.icons8.com/material-outlined/40/restart--v1.png" />
                    </div>
